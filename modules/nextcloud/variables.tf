...
variable "nextcloud_name" {
  description = "NextCloud Database User Name."
}

variable "nextcloud_password" {
  description = "NextCloud Database User Password."
}

variable "nextcloud_database" {
  description = "NextCloud Database Name."
}

variable "nextcloud_admin" {
...
variable "object_storage_bucket" {
  description = "Object Storage Bucket's Name"
}

variable "object_storage_hostname" {
  description = "Object Storage's Hostname"
}

variable "object_storage_region" {
  description = "Object Storage's Region"
}

variable "object_storage_key" {
  description = "Object Storage's Key"
}

variable "object_storage_secret" {
  description = "Object Storage's Secret"
}
