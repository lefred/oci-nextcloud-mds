...
variable "nextcloud_admin_pass" {
  ...
  default     = "MyNextP4ssword!"
}

variable "object_storage_bucket" {
  description = "OCI Object Storage Bucket's Name"
  default = "nextcloud"
}
...
variable "nextcloud_instance_name" {
  description = "Name of the NextCloud compute instance"
  default     = "NextCloudServer"
}
